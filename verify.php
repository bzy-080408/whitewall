...
<div class="form-group">
    <label for="exampleBT1" class="text-light"">验证邮箱:</label>
    <input type="text" class="form-control bg-dark text-light" id="em" name="email" aria-describedby="BTHelp"><?php echo "<span class=error>*" . $emailErr . "</span>"; ?>
  </div>
<button id="sub">发送验证码</button>
</br>
<div class="form-group">
    <label for="exampleZW1" class="text-light">验证码：</label>
    <input class="form-control bg-dark text-light" id="exampleZW1" name="yanzheng" aria-describedby="ZWHelp"></textarea><?php echo "<span class=error>*" . $verifyErr . "</span>"; ?><br/>
  </div>
...
function register()
{
    $a='<script>alert("验证成功!即将返回添加页面!");</script>';
    echo $a;
